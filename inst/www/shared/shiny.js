...
(function () {
  ...
  (function () {
    ...
    this.getTestEndpointUrl = function () {
      ...
      var inputs = _ref$inputs === undefined ? true : _ref$inputs;
      var _ref$outputs = _ref.outputs;
      var outputs = _ref$outputs === undefined ? true : _ref$outputs;
      var _ref$exports = _ref.exports;
      var exports = _ref$exports === undefined ? true : _ref$exports;
      var _ref$format = _ref.format;
      var format = _ref$format === undefined ? "rds" : _ref$format;
      ...
      url += "/session/" + encodeURIComponent(this.config.sessionId) + "/dataobj/shinytest?w=" + encodeURIComponent(this.config.workerId) + "&nonce=" + randomId() + (inputs ? "&input=1" : "") + (outputs ? "&output=1" : "") + (exports ? "&export=1" : "") + "&format=" + format;
